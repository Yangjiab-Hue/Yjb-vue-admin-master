    ...
    <div class="menu">
      ...
      <div class="container">
        <dl v-for="(menu, index) of menuService.menus.value" :key="index">
          <dt @click="menuService.close.value ? '' : (menu.isActive = !menu.isActive)">
            <div>
              <i :class="menu.icon" class="mr-2 text-md"></i>
...
.menu-container {
  .menu {
    @apply w-[250px] bg-gray-600 duration-300 h-screen z-50;
    .logo {
    ...
    .container {
      ...
      dl {
        ...
        dd {
          div {
            @apply mt-3 py-2 mx-4 rounded-md pl-4  duration-300 cursor-pointer bg-gray-700 hover:bg-violet-600;
            &.active {
              @apply bg-violet-700;
            }
          }
